...
public class LivingUtility
{
	...
	private void addEntity()
	{
		...
		//表示名の設定
		//LanguageRegistry.instance().addStringLocalization("entity.Chast.name", "en_US", "Chast");
		//LanguageRegistry.instance().addStringLocalization("entity.Chast.name", "ja_JP", "チャスト");
	}
	...
	{
		/*
		ItemStack Core = new ItemStack(Item_LUMaterial, 1, 0);
		//LanguageRegistry.addName(Core, "Utility Core");

		ItemStack Key = new ItemStack(Item_LUKey, 1, 0);
		//LanguageRegistry.addName(Key, "Utility Key");

		for (int i = 0; i <= 2; i++)
		{
			//LanguageRegistry.addName(new ItemStack(Item_LUWand, 1, i), "Utility Wand");
		}
		 */
	}
}
